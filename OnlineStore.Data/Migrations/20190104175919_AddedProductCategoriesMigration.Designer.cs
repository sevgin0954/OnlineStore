...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20190104175919_AddedProductCategoriesMigration")]
    partial class AddedProductCategoriesMigration
    {
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 4, 19, 59, 18, 592, DateTimeKind.Local).AddTicks(3745));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 7, 19, 59, 18, 650, DateTimeKind.Local).AddTicks(2314));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 4, 19, 59, 18, 647, DateTimeKind.Local).AddTicks(8004));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 4, 19, 59, 18, 696, DateTimeKind.Local).AddTicks(7975));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 4, 19, 59, 18, 708, DateTimeKind.Local).AddTicks(837));
