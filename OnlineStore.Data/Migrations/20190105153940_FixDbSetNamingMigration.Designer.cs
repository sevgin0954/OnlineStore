...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20190105153940_FixDbSetNamingMigration")]
    partial class FixDbSetNamingMigration
    {
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 17, 39, 39, 909, DateTimeKind.Local).AddTicks(2936));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 8, 17, 39, 39, 944, DateTimeKind.Local).AddTicks(4648));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 17, 39, 39, 943, DateTimeKind.Local).AddTicks(198));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 17, 39, 39, 973, DateTimeKind.Local).AddTicks(7103));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 17, 39, 39, 981, DateTimeKind.Local).AddTicks(9093));
            ...
            modelBuilder.Entity("OnlineStore.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 17, 39, 39, 894, DateTimeKind.Local).AddTicks(332));
