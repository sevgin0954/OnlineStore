...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20181226140107_ChangeDistrinctMigration")]
    partial class ChangeDistrinctMigration
    {
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 26, 16, 1, 6, 481, DateTimeKind.Local).AddTicks(6408));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 29, 16, 1, 6, 519, DateTimeKind.Local).AddTicks(3336));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 26, 16, 1, 6, 517, DateTimeKind.Local).AddTicks(8645));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 26, 16, 1, 6, 546, DateTimeKind.Local).AddTicks(5271));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 26, 16, 1, 6, 555, DateTimeKind.Local).AddTicks(3582));
