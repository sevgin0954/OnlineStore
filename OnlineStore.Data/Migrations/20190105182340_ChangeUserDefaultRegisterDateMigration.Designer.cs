...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20190105182340_ChangeUserDefaultRegisterDateMigration")]
    partial class ChangeUserDefaultRegisterDateMigration
    {
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 20, 23, 38, 808, DateTimeKind.Local).AddTicks(1629));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 8, 20, 23, 39, 10, DateTimeKind.Local).AddTicks(7118));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 20, 23, 39, 5, DateTimeKind.Local).AddTicks(4806));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 20, 23, 39, 153, DateTimeKind.Local).AddTicks(3745));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 20, 23, 39, 182, DateTimeKind.Local).AddTicks(67));
            ...
            modelBuilder.Entity("OnlineStore.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 18, 23, 38, 760, DateTimeKind.Utc).AddTicks(8759));
