...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20190325211515_AddedUserFavoriteProductMigration")]
    partial class AddedUserFavoriteProductMigration
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 3, 25, 23, 15, 14, 970, DateTimeKind.Local).AddTicks(732));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 3, 28, 23, 15, 15, 1, DateTimeKind.Local).AddTicks(9238));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 3, 25, 23, 15, 15, 0, DateTimeKind.Local).AddTicks(2391));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 3, 25, 23, 15, 15, 30, DateTimeKind.Local).AddTicks(3602));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 3, 25, 23, 15, 15, 37, DateTimeKind.Local).AddTicks(7782));
            ...
            modelBuilder.Entity("OnlineStore.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 3, 25, 21, 15, 14, 952, DateTimeKind.Utc).AddTicks(7851));
            ...
            modelBuilder.Entity("OnlineStore.Models.UserFavoriteProduct", b =>
                {
                    b.Property<string>("ProductId");
