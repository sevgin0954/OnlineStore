...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20190102142707_AddFullNamePropToUserMigration")]
    partial class AddFullNamePropToUserMigration
    {
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 2, 16, 27, 6, 762, DateTimeKind.Local).AddTicks(6371));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 16, 27, 6, 807, DateTimeKind.Local).AddTicks(6161));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 2, 16, 27, 6, 805, DateTimeKind.Local).AddTicks(9323));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 2, 16, 27, 6, 841, DateTimeKind.Local).AddTicks(6031));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 2, 16, 27, 6, 854, DateTimeKind.Local).AddTicks(6105));
