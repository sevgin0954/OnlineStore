...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20190105145411_AddedRegisterDateToUserMigration")]
    partial class AddedRegisterDateToUserMigration
    {
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 16, 54, 11, 151, DateTimeKind.Local).AddTicks(7118));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 8, 16, 54, 11, 182, DateTimeKind.Local).AddTicks(2863));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 16, 54, 11, 180, DateTimeKind.Local).AddTicks(7630));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 16, 54, 11, 210, DateTimeKind.Local).AddTicks(9306));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 16, 54, 11, 219, DateTimeKind.Local).AddTicks(1543));
            ...
            modelBuilder.Entity("OnlineStore.Models.User", b =>
                {
                    ...
                    b.Property<DateTime>("RegisterDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2019, 1, 5, 16, 54, 11, 135, DateTimeKind.Local).AddTicks(8681));
