        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    PromoPrice = table.Column<decimal>(nullable: true),
                    CountsLeft = table.Column<int>(nullable: false),
                    Description = table.Column<string>(maxLength: 10000, nullable: false),
                    OrderQuantity = table.Column<int>(nullable: false, defaultValue: 1),
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_DeliverysInfos", x => x.Id);
                    table.ForeignKey(
                        name: "FK_DeliverysInfos_Districts_DistrictId",
                        column: x => x.DistrictId,
                        principalTable: "Districts",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_DeliverysInfos_AspNetUsers_UserId",
                        column: x => x.UserId,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Description = table.Column<string>(maxLength: 10000, nullable: false),
                    StarsCount = table.Column<int>(maxLength: 5, nullable: false),
                    IsVerified = table.Column<bool>(nullable: false),
                    LikesCount = table.Column<int>(nullable: false),
                    DislikesCount = table.Column<int>(nullable: false),
                    PostDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 12, 17, 19, 22, 19, 755, DateTimeKind.Local).AddTicks(7175)),
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    Id = table.Column<string>(nullable: false),
                    OrderDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 12, 17, 19, 22, 19, 636, DateTimeKind.Local).AddTicks(7552)),
                    TotalPrice = table.Column<decimal>(nullable: false),
                    DeliveryExpectedTime = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 12, 20, 19, 22, 19, 646, DateTimeKind.Local).AddTicks(2354)),
                    DeliveryPrice = table.Column<decimal>(nullable: false),
                    PaymentTypeId = table.Column<string>(nullable: true),
                    DeliveryInfoId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    DislikesCount = table.Column<int>(nullable: false),
                    IsVerified = table.Column<bool>(nullable: false),
                    PostDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 12, 17, 19, 22, 19, 528, DateTimeKind.Local).AddTicks(4764)),
                    UserId = table.Column<string>(nullable: true),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<string>(nullable: false),
                    Description = table.Column<string>(maxLength: 10000, nullable: false),
                    PostDate = table.Column<DateTime>(nullable: false, defaultValue: new DateTime(2018, 12, 17, 19, 22, 19, 729, DateTimeKind.Local).AddTicks(5648)),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_DeliverysInfos_DistrictId",
                table: "DeliverysInfos",
                column: "DistrictId");

            migrationBuilder.CreateIndex(
                name: "IX_DeliverysInfos_UserId",
                table: "DeliverysInfos",
                column: "UserId");
