...
namespace OnlineStore.Data.Migrations
{
    ...
    [Migration("20181217172220_InitialMigration")]
            ...
            modelBuilder.Entity("OnlineStore.Models.Comment", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 17, 19, 22, 19, 528, DateTimeKind.Local).AddTicks(4764));
            ...
            modelBuilder.Entity("OnlineStore.Models.Order", b =>
                {
                    ...
                    b.Property<DateTime>("DeliveryExpectedTime")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 20, 19, 22, 19, 646, DateTimeKind.Local).AddTicks(2354));
                    ...
                    b.Property<DateTime>("OrderDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 17, 19, 22, 19, 636, DateTimeKind.Local).AddTicks(7552));
            ...
            modelBuilder.Entity("OnlineStore.Models.Question", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 17, 19, 22, 19, 729, DateTimeKind.Local).AddTicks(5648));
            ...
            modelBuilder.Entity("OnlineStore.Models.Review", b =>
                {
                    ...
                    b.Property<DateTime>("PostDate")
                        .ValueGeneratedOnAdd()
                        .HasDefaultValue(new DateTime(2018, 12, 17, 19, 22, 19, 755, DateTimeKind.Local).AddTicks(7175));
